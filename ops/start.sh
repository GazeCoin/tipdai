...
TIPDAI_LOG_LEVEL="${TIPDAI_LOG_LEVEL:-4}"
...
TIPDAI_TWITTER_APP_ACCESS_TOKEN="${TIPDAI_TWITTER_APP_ACCESS_TOKEN}"
...
TIPDAI_TELEGRAM_BOT_ID="${TIPDAI_TELEGRAM_BOT_ID}"
TIPDAI_TELEGRAM_TOKEN="${TIPDAI_TELEGRAM_TOKEN}"
...
services:
  ...
  bot:
    ...
    environment:
      ...
      TELEGRAM_BOT_ID: $TIPDAI_TELEGRAM_BOT_ID
      TELEGRAM_TOKEN: $TIPDAI_TELEGRAM_TOKEN
    secrets:
      - $mnemonic
      - ${project}_db_password
    volumes:
